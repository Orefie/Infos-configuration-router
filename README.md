...
# 3. Le .exe est dans dist/
dist\FULL_extraction_LB5.exe
```
...
⚠️ **IMPORTANT** : La Livebox **DOIT être connectée à Internet** (voyant vert) pour que les options DHCP soient disponibles.

1. Brancher la Livebox sur la fibre
2. Attendre que le voyant Internet soit **vert**
3. Connecter votre PC à la Livebox (Ethernet ou WiFi)
...
**Solution :**
1. Vérifier le voyant Internet sur la Livebox (doit être **vert**)
...
Voir le guide complet : [INSTALL_RAPIDE.bbcode](../INSTALL_RAPIDE.bbcode)
